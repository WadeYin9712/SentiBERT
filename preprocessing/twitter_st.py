...
with open(os.path.join(args.tree_dir, 'twitter_'+args.stage+'.txt.json'), 'r') as f:
    data = json.load(f)
    
f1 = open(os.path.join(args.data_dir, 'twitter_'+args.stage+'_text_new.txt'), 'w')
f2 = open(os.path.join(args.data_dir, 'twitter_'+args.stage+'.txt'), 'r')
...
twitter_label = np.load(os.path.join(args.data_dir, 'twitter_'+args.stage+'_label.npy'))
expression = []  
...
np.save(os.path.join(args.data_dir, 'twitter_'+args.stage+'_span.npy'), span)
np.save(os.path.join(args.data_dir, 'twitter_'+args.stage+'_span_3.npy'), span_3)
np.save(os.path.join(args.data_dir, 'twitter_label_'+args.stage+'.npy'), label)
np.save(os.path.join(args.data_dir, 'twitter_'+args.stage+'_split.npy'), split)
